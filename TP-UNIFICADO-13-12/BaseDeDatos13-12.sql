...
CREATE TABLE `bloque` (
  `idBloque` int(11) unsigned NOT NULL AUTO_INCREMENT,
  ...
  KEY `fk_Pregunta Evaluada_has_Cuestionario_Cuestionario1` (`Cuestionario_idCuestionario`),
  KEY `fk_Pregunta Evaluada_has_Cuestionario_Pregunta Evaluada1` (`Pregunta Evaluada_idPregunta Evaluada`),
  CONSTRAINT `fk_Pregunta Evaluada_has_Cuestionario_Cuestionario1` FOREIGN KEY (`Cuestionario_idCuestionario`) REFERENCES `cuestionario` (`idCuestionario`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Pregunta Evaluada_has_Cuestionario_Pregunta Evaluada1` FOREIGN KEY (`Pregunta Evaluada_idPregunta Evaluada`) REFERENCES `pregunta evaluada` (`idPregunta Evaluada`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2011-12-13 22:00:14
