...
namespace Entidades
{
    public class PuestoEvaluado
    {
        ...
        /* Metodo Constructor */
        public PuestoEvaluado(string cod, string nomb, string emp, string desc)
        {
            codigo = cod; //el codigo es seteado unicamente al iniciar el Puesto.
            fecha_Comienzo = DateTime.Now;
            setNombre(nomb);
            setEmpresa(emp);
            setDescripcion(desc);
        ...
        public PuestoEvaluado(string cod, string nomb, string emp, string desc, List<Caracteristica> caract)
        {
            codigo = cod; //el codigo es seteado unicamente al iniciar el Puesto.
            setNombre(nomb);
            setEmpresa(emp);
