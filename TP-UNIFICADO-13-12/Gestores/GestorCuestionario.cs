...
namespace Gestores
{
    public class GestorCuestionario
    {
        ...
        {
            ArrayList retornoBD = admBD.recuperarCuestionario(candidatoAsociado);//solicita a la base de datos el retorno del cuest
        ...
        {
            ArrayList retornoBD = admBD.recuperarCuestionario(candidatoAsociado);
